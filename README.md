...
- Test login credentials have been uploaded to the Devpost project if judges want to try it out for themselves.
...
- You can also specify how many items to generate; Stepfunctions are used to run multiple instances of the generator Lambda.
